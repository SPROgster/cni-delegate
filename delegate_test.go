...
//}
//
//var _ = Describe("delegate Operations", func() {
...
//		Expect(err).NotTo(HaveOccurred())
//
//		dataDir, err = ioutil.TempDir("", "delegate_test")
//		Expect(err).NotTo(HaveOccurred())
//	})
//
//	AfterEach(func() {
...
//
//		// Make sure delegate link exists in the target namespace
...
//		Expect(err).NotTo(HaveOccurred())
//
//		// Make sure delegate link has been deleted
//		err = targetNS.Do(func(ns.NetNS) error {
//			defer GinkgoRecover()
//
//			link, err := netlink.LinkByName(IFNAME)
...
//		ver := ver
//
//		It(fmt.Sprintf("[%s] configures and deconfigures a delegate link with ADD/DEL", ver), func() {
//			dnsConf := types.DNS{
...
//		})
//
//		It(fmt.Sprintf("[%s] configures and deconfigures a dual-stack delegate link with ADD/DEL", ver), func() {
//			conf := fmt.Sprintf(`{
//			    "cniVersion": "%s",
//			    "name": "mynet",
//			    "type": "delegate",
...
//			defer os.RemoveAll(resolvConfPath)
//
//			for _, delegateDNSConf := range []types.DNS{
//				{
...
//				},
//			} {
//				dnsConfBytes, err := json.Marshal(delegateDNSConf)
//				Expect(err).NotTo(HaveOccurred())
//
//				conf := fmt.Sprintf(`{
//				    "cniVersion": "%s",
...
//
//				doTest(conf, ver, 1, delegateDNSConf, targetNS)
//			}
//		})
//
...
//		})
//
//		It(fmt.Sprintf("[%s] deconfigures an unconfigured delegate link with DEL", ver), func() {
//			const IFNAME = "delegate0"
//
//			conf := fmt.Sprintf(`{
//			    "cniVersion": "%s",
